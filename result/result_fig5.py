...
if __name__ == '__main__':
    ...
    for tissue_type, t in zip(['appendix', 'colon'], [12, 26]):
        ...
        print(f'Complex amplitude reconstruction of {tissue_type} tissue from the diffraction intensity measured at {t}mm.')
        ...
        for m in trained_model:
            ...
            fig.tight_layout()
            path_saved_figure=os.path.join(test_result_path, f'{tissue_type}_{t}mm.png')
            ...
            path_saved_data = os.path.join(test_result_path, f'{tissue_type}_{t}mm.mat')
