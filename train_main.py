...
if __name__ == '__main__':
    ...
    saving_path = os.path.join(args.result_root,
                               f'{args.experiment}_@re_gr{args.gan_regularizer}hr{args.diffraction_regularizer}fr{args.field_regularizer}sr{args.ssim_regularizer}dr{args.distance_regularizer}pr{args.penalty_regularizer}_@tr_diffraction_{args.train_diffraction_list}_@distance_{args.distance_min}_{args.distance_max}')
